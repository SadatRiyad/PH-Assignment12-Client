        ...
        <footer className="bg-customGulabi text-muted-foreground py-10 text-white">
            <div className="container mx-auto text-center justify-center w-full flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row gap-4 mt-2 text-white">
                    ...
                    <Link to="/biodatas" className="hover:text-customBlue hover:font-semibold hover:-translate-y-[1px] transition-all duration-75">Biodatas</Link>
                ...
                <p className="text-white mt-2">Copyright © 2024 <a href="#" className='font-bold text-customBlue'>BB-Matrimony </a>- All right reserved.</p>
            </div>
        </footer>
    );
};
