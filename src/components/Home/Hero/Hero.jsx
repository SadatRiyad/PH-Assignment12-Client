            ...
            <div className="hero a1 relative bg-cover bg-center h-[550px] flex items-center justify-center" >
                <div className="hero-content text-center text-neutral-content">
                    <div className="px-8" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000" >
                        ...
                        <a href='#' className="text-xs px-6 py-3 bg-customRed border-customRed text-white hover:text-customRed rounded border hover:border-customRed hover:bg-white opacity-90 font-bold mt-6 md:text-base">Join Now</a>
